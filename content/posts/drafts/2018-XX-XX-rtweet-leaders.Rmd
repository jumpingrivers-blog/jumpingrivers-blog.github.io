...
lead_r_twitt = left_join(lead_r_tl, names, by = c("screen_name"))
```
...
We can install the package from GitHub and we also need to install the GitHub version of **rtweet**
```{r, eval = FALSE}
...
[![](static/img/logos/300_125.jpg)](https://www.jumpingrivers.com/?utm_source=blog&utm_medium=image&utm_campaign=basegraphics2018)
