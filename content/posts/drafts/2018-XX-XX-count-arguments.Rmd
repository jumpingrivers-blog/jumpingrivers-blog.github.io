...
```{r}
# Sort the order to match largest vector
pkg %>% 
  ...
  facet_wrap(~package) + 
  xlim(c(0, 25)) + 
  theme_bw()# Only removes three values
...
It's no surprise `...` and `x` are up there! __WHY??__ We could also do this per package...
