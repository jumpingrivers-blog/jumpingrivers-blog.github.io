...
around the idea of using a data frame for manipulating text. Most of the details are from his 
(with Julie Silge) book on [Text Mining with R](https://www.tidytextmining.com/).
