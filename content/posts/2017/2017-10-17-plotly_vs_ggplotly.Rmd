...
### Analysis
Let's loads and take a look at the data.
```{r}
...
ggplotly(ggplot(all) + geom_point(aes(y = value, x = date, colour = birth_stat)))

plot_ly(all, x = ~date, y = ~value, color = ~birth_stat, type = "scatter")
```
...
time2 = microbenchmark(ggplotly = 
                                 ...
                                 plotly = plot_ly(all, x = ~date, y = ~value, 
