...
to (and can!) attend. To help plan your (ahem) work trips, we thought it would be useful to 
list the upcoming main attractions.

We maintain a list of [upcoming rstats](https://jumpingrivers.github.io/meetingsR/) conferences. 
To keep up to date, just follow our [twitter bot](https://twitter.com/rstats_meetings).
...
Participants from academia and industry mingle for two days to exchange ideas about current research, best practices and applications. A single-track program permits continued focus on a series of refereed submissions. We hear
there's a lively social program rounds out the event.
...
[![](/img/logos/300_125.jpg)](https://www.jumpingrivers.com/?utm_source=blog&utm_medium=image&utm_campaign=2017conferences)
