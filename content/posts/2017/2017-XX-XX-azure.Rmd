...
tags: [rstats,azure,cloud,rstudio]
---
...
```
To ensure that ubuntu is up to date on our virtual machine, ubuntu is up-to-date, we invoke 
super sudo powers. First we update the list of ubuntu packages
```
sudo apt-get update
```
